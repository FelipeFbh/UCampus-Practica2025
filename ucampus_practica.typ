...
#show: conf.with(
  titulo: "UCampus-Chat",
  autor: (nombre: "Felipe Olivares E.", pronombre: pronombre.elle),
  supervisor: (nombre: "Valu y Felipes", pronombre: pronombre.ella),
...
Semana 1: Instalacion de UPracticas
- Comprension del codigo php y UPracticas
- Implementacion de api con gemini para generar notas. (Creacion modulo y conexion al modulo de notas)
- Generacion de prompt con acceso a la data de las notas, operaciones y funciones.
- Investigacion del etiquetador
- Creacion de modelo BETO para clasificar una label
Semana 2: Acceso al tarro
- Creacion de mini-dataset para entrenar el modelo
- Creacion modelo beto orientado a multilabel
- Se comenzo el estudio del recuento
- Se implemento el modelo llama usando vllm
- Se utilizo flask para manejar las solicitudes tanto para dirigirlas al etiquetador como al vllm
- Optimizacion de prompts para el calculo de la formula para llama
- Se implemente Gunicorn para su deploy
- Presentacion S2 al equipo dev 

Semana 3: 
- Se testearon varios modelos, logrando funcionar phi-3.5-mini. Esto con el fin de buscar un mejor modelo para la generacion de formulas.
- Generacion del prompt para phi.
-> Llevar a cabo varios prompts para que realice tareas especificas.


Por Realizar:
- Multiprompt
- Entrenar con mejores prompts
- Investigar recuento
- Prompt para busqueda de cursos
