...
#let conf(
  ...
  practica: 2, // puede ser práctica 1 o 2
  codigo: "CC5901", // CC4901 para práctica I, CC5901 para práctica II
  ingenieria: "Ingeniería Civil en Computación", // Nombre de la carrera
  correo: "example@example.com", // Correo de autor
  telefono: "+56 9 example", // Número de teléfono de autor
  periodo: "Enero - Febrero 2025", // Periodo en que se realizó la práctica
  empresa: "Centro Tecnológico Ucampus.", // Nombre de la empresa
  ...
  telefono-supervisor: "+56 9 example", // Número de teléfono de supervisor
